...
public class Blosum50 {
	...
	public static void main(String[] args) {
		String s1 ="CACTAAG-CA-TCAGC";
		String s2 ="-A-TAGGGCAATCT--";
		float res=0;
		int l=s1.length();
		for(int i=0;i<l;i++) {
			//System.out.println(i+"score="+getScore(s1.charAt(i),s2.charAt(i)));
			res+=getScore(s1.charAt(i),s2.charAt(i));
			System.out.println(res);
		}
		System.out.print("Final "+res);
		
		//System.out.println(getScore('A','R'));
	}
